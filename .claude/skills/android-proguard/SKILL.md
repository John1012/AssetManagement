...
description: Analyzes Android build files and R8 keep rules to identify redundancies,
  overly broad rules, and rules that subsume library consumer rules. Use this skill
  whenever the user wants to optimize app size, audit or clean up ProGuard/R8 keep rules,
  troubleshoot R8 configuration, reduce APK size, or review whether existing keep rules
  are still needed. Also use when the user mentions bloated release builds, unnecessary
  keep rules, or wants to upgrade to AGP 9.
